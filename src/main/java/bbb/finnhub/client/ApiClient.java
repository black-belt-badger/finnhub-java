...
package bbb.finnhub.client;

import bbb.finnhub.client.auth.Authentication;
import bbb.finnhub.client.auth.HttpBasicAuth;
import bbb.finnhub.client.auth.HttpBearerAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    protected String basePath = "https://finnhub.io/api/v1";
    ...
    protected WebClient buildWebClient(Vertx vertx, JsonObject config) {
        ...
        if (!config.containsKey("userAgent")) {
            config.put("userAgent", "OpenAPI-Generator/1.0.2/java");
        }
    ...
    public static class AuthInfo {
        ...
        public void addApiKeyAuthentication(String apikey, String apiKeyPrefix) {
           ApiKeyAuth auth = new ApiKeyAuth("query","token");

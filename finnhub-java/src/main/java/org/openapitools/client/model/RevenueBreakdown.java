...
import org.openapitools.client.model.BreakdownItem;
 ...
 */
@JsonPropertyOrder({
  RevenueBreakdown.JSON_PROPERTY_SYMBOL,
  RevenueBreakdown.JSON_PROPERTY_CIK,
  RevenueBreakdown.JSON_PROPERTY_DATA
})
...
public class RevenueBreakdown {
  ...
  @javax.annotation.Nullable
  private List<BreakdownItem> data = new ArrayList<>();

  public RevenueBreakdown() {
  }

  public RevenueBreakdown symbol(@javax.annotation.Nullable String symbol) {
  ...
  public RevenueBreakdown cik(@javax.annotation.Nullable String cik) {
  ...
  public RevenueBreakdown data(@javax.annotation.Nullable List<BreakdownItem> data) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<BreakdownItem> data) {
    this.data = data;
  }

 ...
 */
@JsonPropertyOrder({
  MutualFundCountryExposureData.JSON_PROPERTY_COUNTRY,
  MutualFundCountryExposureData.JSON_PROPERTY_EXPOSURE
})
...
public class MutualFundCountryExposureData {
  ...
  public MutualFundCountryExposureData country(@javax.annotation.Nullable String country) {
  ...
  public MutualFundCountryExposureData exposure(@javax.annotation.Nullable Float exposure) {

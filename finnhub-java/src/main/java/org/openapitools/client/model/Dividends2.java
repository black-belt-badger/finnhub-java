...
import org.openapitools.client.model.Dividends2Info;
 ...
 */
@JsonPropertyOrder({
  Dividends2.JSON_PROPERTY_SYMBOL,
  Dividends2.JSON_PROPERTY_DATA
})
...
public class Dividends2 {
  ...
  @javax.annotation.Nullable
  private List<Dividends2Info> data = new ArrayList<>();

  public Dividends2() {
  }

  public Dividends2 symbol(@javax.annotation.Nullable String symbol) {
  ...
  public Dividends2 data(@javax.annotation.Nullable List<Dividends2Info> data) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<Dividends2Info> data) {
    this.data = data;
  }

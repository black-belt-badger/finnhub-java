 ...
 */
@JsonPropertyOrder({
  CryptoCandles.JSON_PROPERTY_O,
  CryptoCandles.JSON_PROPERTY_H,
  CryptoCandles.JSON_PROPERTY_L,
  CryptoCandles.JSON_PROPERTY_C,
  CryptoCandles.JSON_PROPERTY_V,
  CryptoCandles.JSON_PROPERTY_T,
  CryptoCandles.JSON_PROPERTY_S
})
...
public class CryptoCandles {
  ...
  public CryptoCandles o(@javax.annotation.Nullable List<Float> o) {
  ...
  public CryptoCandles h(@javax.annotation.Nullable List<Float> h) {
  ...
  public CryptoCandles l(@javax.annotation.Nullable List<Float> l) {
  ...
  public CryptoCandles c(@javax.annotation.Nullable List<Float> c) {
  ...
  public CryptoCandles v(@javax.annotation.Nullable List<Float> v) {
  ...
  public CryptoCandles t(@javax.annotation.Nullable List<Long> t) {
  ...
  public CryptoCandles s(@javax.annotation.Nullable String s) {

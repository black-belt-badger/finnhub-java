 ...
 */
@JsonPropertyOrder({
  ForexCandles.JSON_PROPERTY_O,
  ForexCandles.JSON_PROPERTY_H,
  ForexCandles.JSON_PROPERTY_L,
  ForexCandles.JSON_PROPERTY_C,
  ForexCandles.JSON_PROPERTY_V,
  ForexCandles.JSON_PROPERTY_T,
  ForexCandles.JSON_PROPERTY_S
})
...
public class ForexCandles {
  ...
  public ForexCandles o(@javax.annotation.Nullable List<Float> o) {
  ...
  public ForexCandles h(@javax.annotation.Nullable List<Float> h) {
  ...
  public ForexCandles l(@javax.annotation.Nullable List<Float> l) {
  ...
  public ForexCandles c(@javax.annotation.Nullable List<Float> c) {
  ...
  public ForexCandles v(@javax.annotation.Nullable List<Float> v) {
  ...
  public ForexCandles t(@javax.annotation.Nullable List<Float> t) {
  ...
  @JsonProperty(JSON_PROPERTY_T)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setT(@javax.annotation.Nullable List<Float> t) {
    this.t = t;
  }

  public ForexCandles s(@javax.annotation.Nullable String s) {

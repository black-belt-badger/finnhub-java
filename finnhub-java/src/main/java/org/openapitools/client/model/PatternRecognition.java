 ...
 */
@JsonPropertyOrder({
  PatternRecognition.JSON_PROPERTY_POINTS
})
...
public class PatternRecognition {
  ...
  public PatternRecognition points(@javax.annotation.Nullable List<Object> points) {
    
    this.points = points;
    return this;
  }

  public PatternRecognition addPointsItem(Object pointsItem) {
    if (this.points == null) {
  ...
  @JsonProperty(JSON_PROPERTY_POINTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPoints(@javax.annotation.Nullable List<Object> points) {
    this.points = points;
  }

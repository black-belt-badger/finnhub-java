...
import org.openapitools.client.model.CongressionalTransaction;
 ...
 */
@JsonPropertyOrder({
  CongressionalTrading.JSON_PROPERTY_SYMBOL,
  CongressionalTrading.JSON_PROPERTY_DATA
})
...
public class CongressionalTrading {
  ...
  @javax.annotation.Nullable
  private List<CongressionalTransaction> data = new ArrayList<>();

  public CongressionalTrading() {
  }

  public CongressionalTrading symbol(@javax.annotation.Nullable String symbol) {
  ...
  public CongressionalTrading data(@javax.annotation.Nullable List<CongressionalTransaction> data) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<CongressionalTransaction> data) {
    this.data = data;
  }

...
import org.openapitools.client.model.InstitutionalProfileInfo;
 ...
 */
@JsonPropertyOrder({
  InstitutionalProfile.JSON_PROPERTY_CIK,
  InstitutionalProfile.JSON_PROPERTY_DATA
})
...
public class InstitutionalProfile {
  ...
  @javax.annotation.Nullable
  private List<InstitutionalProfileInfo> data = new ArrayList<>();

  public InstitutionalProfile() {
  }

  public InstitutionalProfile cik(@javax.annotation.Nullable String cik) {
  ...
  public InstitutionalProfile data(@javax.annotation.Nullable List<InstitutionalProfileInfo> data) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<InstitutionalProfileInfo> data) {
    this.data = data;
  }

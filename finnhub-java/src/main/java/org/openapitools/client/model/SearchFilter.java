 ...
 */
@JsonPropertyOrder({
  SearchFilter.JSON_PROPERTY_ID,
  SearchFilter.JSON_PROPERTY_NAME
})
...
public class SearchFilter {
  ...
  public SearchFilter id(@javax.annotation.Nullable String id) {
  ...
  public SearchFilter name(@javax.annotation.Nullable String name) {
